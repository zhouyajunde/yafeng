...
- (void)timerFireMethod:(NSTimer *)theTimer
{
    ...
    //format of hour
    NSString *str_hour = [NSString stringWithFormat:@"%02d",[self getCurrentTime]/3600];
    //format of minute
    NSString *str_minute = [NSString stringWithFormat:@"%02d",([self getCurrentTime]%3600)/60];
    //format of second
    NSString *str_second = [NSString stringWithFormat:@"%02d",[self getCurrentTime]%60];
    //format of time
